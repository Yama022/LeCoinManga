      ...
      <div className='description__item__content'>
        ...
        <div className="description__item__content__description">
            <p>Chaque année au Japon, on recense plus de 10 000 morts inexpliquées et portés disparus.
              ...
              Monstres assoiffés de sang, combats épiques et magie surpuissante : découvrez la nouvelle bombe dark fantasy ! Au cœur d'une lutte millénaire entre exorcistes et démons, comment garder son humanité alors même que le mal se tapit au plus profond de soi ?</p>
          </div>
      </div>
